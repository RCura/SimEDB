...
fileToWrite <- sprintf("~/mapd-docker-storage/data/mapd_import/%s_MapD_global.csv.bz2", prefixe_files)
fileToRead <- str_replace(fileToWrite, pattern = "~/mapd-docker-storage/", replacement = "/mapd-storage/")
...
fileToWrite <- sprintf("~/mapd-docker-storage/data/mapd_import/%s_MapD_chateaux.csv.bz2", prefixe_files)
fileToRead <- str_replace(fileToWrite, pattern = "~/mapd-docker-storage/", replacement = "/mapd-storage/")
